...
class dsSearchAgent_Admin {
	...
	static function RegisterTinyMceButton($buttons) {
		array_push($buttons, "separator", "idxlisting", "idxlistings", "idxlinkbuilder", "idxquicksearch","idxregistrationform");
		return $buttons;
	}
		...
		<h2>Display Settings</h2>
			<table class="form-table">
				...
				<tr>
					...
					<td>
					<?php
							$ResultsDefaultState = isset($options["dsIDXPressPackage"]) && $options["dsIDXPressPackage"] == "pro" ? "grid" : "list";
							if(isset($account_options->IsResultsPageModernView) && !empty($account_options->IsResultsPageModernView) && strtolower($account_options->IsResultsPageModernView) == "true")
							{
								$ResultsDefaultStateClassicView = "";
								$ResultsDefaultStateModernView = !isset($options["ResultsDefaultStateModernView"]) ? $ResultsDefaultState : $options["ResultsDefaultStateModernView"];
							}
							else
							{
						...
						<div style="margin-top: 10px; margin-left: 20px;">
							<input type="radio" id="dsidxpress-ResultsDefaultState-List" name="<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]" value="list" <?php echo @$ResultsDefaultStateClassicView == "list" ? "checked=\"checked\"" : "" ?> <?php echo @ empty($ResultsDefaultStateClassicView) ? "disabled=\"disabled\"" : "" ?> /> <label for="dsidxpress-ResultsDefaultState-List">List</label><br />
							<input type="radio" id="dsidxpress-ResultsDefaultState-ListMap" name="<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]" value="listmap" <?php echo @$ResultsDefaultStateClassicView == "listmap" ? "checked=\"checked\"" : "" ?> <?php echo @ empty($ResultsDefaultStateClassicView) ? "disabled=\"disabled\"" : "" ?> /> <label for="dsidxpress-ResultsDefaultState-ListMap">List + Map</label>
							<?php if (defined('ZPRESS_API') || isset($options["dsIDXPressPackage"]) && $options["dsIDXPressPackage"] == "pro"): ?>
							<br /><input type="radio" id="dsidxpress-ResultsDefaultState-Grid" name="<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]" value="grid" <?php echo @$ResultsDefaultStateClassicView == "grid" ? "checked=\"checked\"" : "" ?> <?php echo @ empty($ResultsDefaultStateClassicView) ? "disabled=\"disabled\"" : "" ?> /> <label for="dsidxpress-ResultsDefaultState-Grid">Grid</label>
							<?php endif ?>
						</div>
						<br/>
						<input type="radio" class="dsidxpress-api-radio" id="dsidxpress-IsResultsPageModernView-ModernView" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[IsResultsPageModernView]" onchange="ResultsPageViewChanged(this)" value="true" <?php echo @ strtolower($account_options->IsResultsPageModernView) == "true" ? "checked=\"checked\"" : "" ?>/> <label for="dsidxpress-IsResultsPageModernView-ModernView">Modern View</label><br />
						<div style="margin-top: 10px; margin-left: 20px;">
							<input type="radio" id="dsidxpress-ResultsDefaultState-List-ModernView" name="<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultStateModernView]" value="list" <?php echo @$ResultsDefaultStateModernView == "list" ? "checked=\"checked\"" : "" ?> <?php echo @ empty($ResultsDefaultStateModernView) ? "disabled=\"disabled\"" : "" ?> /> <label for="dsidxpress-ResultsDefaultState-List-ModernView">List</label>
							<?php if (defined('ZPRESS_API') || isset($options["dsIDXPressPackage"]) && $options["dsIDXPressPackage"] == "pro"): ?>
							...
							<?php endif ?>
							<br /><br />
							<input type="checkbox" id="dsidxpress-ShowMapInResultsPage-check" class="dsidxpress-api-checkbox" <?php checked('true', strtolower($account_options->ShowMapInResultsPage)); ?> <?php echo @ empty($ResultsDefaultStateModernView) ? "disabled=\"disabled\"" : "" ?> /> <label for="dsidxpress-ShowMapInResultsPage-check">Show Map by default</label>
							<input type="hidden" id="dsidxpress-ShowMapInResultsPage" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[ShowMapInResultsPage]" value="<?php echo $account_options->ShowMapInResultsPage;?>" />
						</div>
						<input type="hidden" id="dsidxpress-IsResultsPageModernView" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[IsResultsPageModernView]" value="<?php echo $account_options->IsResultsPageModernView ?>" />
					</td>
				</tr>
				<tr>
					<th>
			...
			<script>
				function ResultsPageViewChanged(ctrl) {
					if(ctrl.value == 'true') {
						...
						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultStateModernView]']").attr('disabled', false);
						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultStateModernView]']")[0].checked = true;

						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]']").attr('disabled', true);
						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]']").attr('checked', false);
						...
						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]']").attr('disabled', false);
						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultState]']")[0].checked = true;

						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultStateModernView]']").attr('disabled', true);
						jQuery("input[type='radio'][name='<?php echo DSIDXPRESS_OPTION_NAME; ?>[ResultsDefaultStateModernView]']").attr('checked', false);
			...
			<form method="post" action="options.php">
				...
				<table class="form-table">
					...
					<?php 
						...
						if(isset($account_options->{'ShowSimilarListings'}) && strtolower($account_options->ShowSimilarListings)=="false") 
							$showSimilarListings ="";						
						if(isset($account_options->{'ShowSimilarSoldListings'}) &&  strtolower($account_options->ShowSimilarSoldListings)=="false")
							$showSimilarSoldListings = "";
						if(isset($account_options->{'ShowMortgageCalculator'}) &&  strtolower($account_options->ShowMortgageCalculator)=="false")
					...
					<tr>
						...
						<td>							
							...
							<input type="hidden" id="dsidxpress-ShowPanel_ShowSimilarListings" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[ShowSimilarListings]" value="<?php echo $account_options->ShowSimilarListings;?>" />
							<span class="description"></span>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<input type="hidden" id="dsidxpress-ShowPanel_ShowSimilarSoldListings" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[ShowSimilarSoldListings]" value="<?php echo $account_options->ShowSimilarSoldListings;?>" />
							<span class="description"></span>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<input type="hidden" id="dsidxpress-ShowPanel_ShowMortgageCalculator" name="<?php echo DSIDXPRESS_API_OPTIONS_NAME; ?>[ShowMortgageCalculator]" value="<?php echo $account_options->ShowMortgageCalculator;?>" />
							<span class="description"></span>
						</td>
					</tr>
...
HTML;
		...
		if(!empty($property_features) && is_array($property_features)){
		    ...
		    foreach ($property_features as $property_feature) {
		        $checked_html = '';
		        $name = htmlentities($property_feature->DisplayName);
				$id = $property_feature->SearchSetupFeatureID;
...
?>
	...
	<div id="dsidxpress-link-builder" class="customlinkdiv">
		...
		<input type="hidden" id="linkBuilderPropertyFeatures" value="<?php echo $property_features_html ?>" />
