                ...
                <table class="form-table tbl_main">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>								<textarea name="popup_message" class="regular-text" id="popup_message"><?php echo get_post_meta( $formid, 'popup_message', true );?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
        ...
        function CF7POPUP_wpcf7_admin_script() {
            ...
            <script type="text/javascript">
                jQuery( document ).ready(function() {
                    var radioValue = $("input[name='popup_templet']:checked").val();
                    ...
                    var f_radioValue = $("input[name='failure_popup_templet']:checked").val();
                    ...
                    jQuery("input[name='failure_popup_templet']").click(function(){
                        var radioValue = $("input[name='failure_popup_templet']:checked").val();
                        if(radioValue == "custom_templet"){
                            jQuery('.failuretr_custom_templet').css("display", "table-row");
                        }else{
